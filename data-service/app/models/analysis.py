...
class SentimentAnalysisResponse(BaseModel):
    ...
    score: float
    label: str
    key_themes: list[str] = Field(default_factory=list, max_length=3)
    risk_factors: list[str] = Field(default_factory=list, max_length=2)
    opportunity_factors: list[str] = Field(default_factory=list, max_length=2)
    article_count: int
