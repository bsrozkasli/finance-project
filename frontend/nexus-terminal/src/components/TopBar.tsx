...
import { Search, RefreshCw, Terminal, Clock, ShieldAlert, User, Plus, BookOpen } from 'lucide-react';
    ...
    <header className="h-16 border-b border-outline-variant bg-bg-base flex items-center justify-between px-6 shrink-0 z-40 relative">
      ...
      <div className="flex-1 max-w-md mx-8 relative">
        <div className="relative">
          ...
          <input
            type="text"
            placeholder="Arama yapın (örn: NVDA, MSFT, Teknoloji...)"
            value={searchQuery}
